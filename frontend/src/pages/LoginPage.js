    ...
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <div className="flex items-center justify-between mb-8">
            ...
            <Button variant="ghost" size="icon" onClick={toggleLanguage} data-testid="login-lang-toggle">
          ...
          <Card className="border-none shadow-none">
            <CardHeader className="px-0">
              <CardTitle className="font-heading text-2xl">{t('welcome_back')}</CardTitle>
      ...
      <div className="hidden lg:flex flex-1 bg-muted relative overflow-hidden">
        ...
        <div className="relative z-10 p-12 flex flex-col justify-end text-white">
          <blockquote className="text-2xl font-heading font-semibold mb-4">
            {language === 'ar' 
              ? '"نظام إدارة المدارس ساعدنا على تنظيم كل عملياتنا الإدارية والتعليمية في مكان واحد"'
              : '"The School Management System helped us organize all our administrative and educational operations in one place"'}
          </blockquote>
          <p className="text-lg opacity-90">
            {language === 'ar' ? '— مدير مدرسة النور الخاصة' : '— Al-Noor Private School Principal'}
          </p>
        </div>
      </div>
    </div>
